...
// ===========================
const char *ssid = "Joe Joe";
const char *password = "0#123Joe#";

void startCameraServer();
void setupLedFlash(int pin);
// URL du serveur qui va traiter l'OCR
const char* serverUrl = "http://192.168.80.251:5000/ocr";
...
void loop() {
  ...
  if (httpResponseCode > 0) {
    ...
    Serial.println("OCR Result: " + response);
  } else {
  ...
  // Libérer le corps de la requête
  free(body);
